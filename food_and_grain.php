...
<body>
    ...
    <header>
        ...
        <div class="cover">
            <div class="import_and_export">
                <img src="img/slider_img/Import and Export_1@3x.png" class="d-block w-100" alt=" Import and Export">
            </div>
            <div class="container carousel-caption cover_content d-none d-md-block">
                ...
                <p class="text-dark"> Our Services - Import and Export </p>               
            </div>
        </div>
    </header>  
    <!-- Section Opened -->
    <section>
        ...
        <div class="container">
            <h2 class="pt-5 pb-2"><strong>Import And Export</strong></h2>
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col-md-4">
                    <div class="card">
                        <img src="img/food_and_grain_1.png" class="card-img-top" alt="Foods">
                        <div class="card-body">
                            <h5 class="card-title Header_2 text-center"><strong>Food Delivery</strong></h5>
                            <p class="card-text para_align">
                                ...
                                amet tempor convallis. Morbi iaculis, nibh sed congue ultrices, ipsum nibh dignissim 
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="img/food_and_grain_2.png" class="card-img-top" alt="Food and Grains">
                        <div class="card-body">
                            <h5 class="card-title Header_2 text-center"><strong>Food Items</strong></h5>
                            <p class="card-text para_align">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et enim sapien. Curabitur 
                                tortor elit, feugiat at dui nec, vestibulum plaicerat turpis. Donec tempor ipsum sit 
                                amet tempor convallis. Morbi iaculis, nibh sed congue ultrices, ipsum nibh dignissim 
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="img/food_and_grain_3.png " class="card-img-top" alt="Foods">
                        <div class="card-body">
                            <h5 class="card-title Header_2 text-center"><strong>Food</strong></h5>
                ...
                <!-- <div class="col-md-6">
                    <div class="card">
                        <img src="img/food_and_grain_4.png" class="card-img-top" alt="Foods Supplies">
                        <div class="card-body">
                            <h5 class="card-title Header_2"><strong>Food and Grain</strong></h5>
                            <p class="card-text para_align">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et enim sapien. Curabitur 
                                tortor elit, feugiat at dui nec, vestibulum plaicerat turpis. Donec tempor ipsum sit 
                                amet tempor convallis. Morbi iaculis, nibh sed congue ultrices, ipsum nibh dignissim 
