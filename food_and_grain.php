...
<body>
    ...
    <section>
        ...
        <h1 class="text-white pt-5">Import And Export</h1>
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title Header_2"><strong>Food Delivery</strong></h5>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title Header_2"><strong>Food Items</strong></h5>
                            <p class="card-text para_align">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et enim sapien. Curabitur 
                                tortor elit, feugiat at dui nec, vestibulum plaicerat turpis. Donec tempor ipsum sit 
                                amet tempor convallis. Morbi iaculis, nibh sed congue ultrices, ipsum nibh dignissim 
                ...
                <div class="col-md-6 ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title Header_2"><strong>Food</strong></h5>
