...
<body>
    ...
    <section>
        ...
        <div class="container mt-5">
            <h1 class="mb-5">For Activities</h1>
            <div class="card-group activity_image">
                <div class="card">
                    <img src="img/activities_1.png" class="card-img-top " alt="Import and Export">
                </div>
                <h2 class="activity_title">Import and Export</h2>
                <div class="card">
                    <img src="img/activities_2.png" class="card-img-top" alt="...">
                </div>
                <div class="card">
                    <img src="img/activities_3.png" class="card-img-top" alt="...">
                </div>
            </div>
            <div class="card-group p-0 mr-0">
                <div class="card">
                    <img src="img/activities_4.png" class="card-img-top" alt="...">
                </div>
                <div class="card">
                    <img src="img/activities_5.png" class="card-img-top" alt="...">
                </div>
                <div class="card">
                    <img src="img/activities_6.png" class="card-img-top" alt="...">
                </div>
            </div>
            <div class="card-group mt-0">
                <div class="card">
                    <img src="img/activities_7.png" class="card-img-top" alt="...">
                </div>
                <div class="card">
                    <img src="img/activities_8.png" class="card-img-top" alt="...">
                </div>
                <div class="card">
                    <img src="img/activities_9.png" class="card-img-top" alt="...">
                </div>
            </div>
        </div>
