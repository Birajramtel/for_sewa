    ...
    <header>
        ...
        <div class="cover">
            <div class="import_and_export">
                <img src="img/slider_img/Real Estate@3x.png" class="d-block w-100" alt=" Real Estate">
            </div>
            <div class="container carousel-caption cover_content d-none d-md-block">
                ...
                <p class="text-dark"> Our Service in Real Estate </p>               
            </div>
        </div>
    </header>  
    <!-- Section Opened -->
    <section>
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col-md-4">
                    <div class="card">
                        <img src="img/real_estate_1.png" class="card-img-top" alt="House to Buy">
                        <div class="card-body">
                            <h5 class="card-title Header_2 text-center"><strong>House to Buy</strong></h5>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="img/real_estate_2.png" class="card-img-top" alt="Real State Business">
                        <div class="card-body">
                            <h5 class="card-title Header_2 text-center"><strong>House on Rent</strong></h5>
                            <p class="card-text para_align">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et enim sapien. Curabitur 
                                tortor elit, feugiat at dui nec, vestibulum plaicerat turpis. Donec tempor ipsum sit 
                                amet tempor convallis. Morbi iaculis, nibh sed congue ultrices, ipsum nibh dignissim 
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="img/real_estate_3.png" class="card-img-top" alt="Real Estate House">
                        <div class="card-body">
                            <h5 class="card-title Header_2 text-center"><strong>House on Rent</strong></h5>
                ...
                <!-- <div class="col-md-6">
                    <div class="card">
                        <img src="img/real_estate_4.png" class="card-img-top" alt="Real Estate House">
                        <div class="card-body">
                            <h5 class="card-title Header_2"><strong>House on Rent</strong></h5>
                            <p class="card-text para_align">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et enim sapien. Curabitur 
                                tortor elit, feugiat at dui nec, vestibulum plaicerat turpis. Donec tempor ipsum sit 
                                amet tempor convallis. Morbi iaculis, nibh sed congue ultrices, ipsum nibh dignissim 
